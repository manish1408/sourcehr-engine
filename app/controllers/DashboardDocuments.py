...
from app.dependencies import get_dashboard_documents_service
...
async def get_all_documents(service: DDService = Depends(get_dashboard_documents_service)):
    try:
        data = await service.get_all_laws()
