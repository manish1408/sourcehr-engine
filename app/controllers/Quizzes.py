...
async def create_quiz(
    ...
    try:
        ...
        data = await service.create_quiz(body,user_id)
...
async def list_quizzes(
    ...
    try:
        user_id = jwt_payload["id"]
        data = await service.list_quizzes(page, limit,user_id)
        return Utils.create_response(data["data"],data["success"],data.get("error", "") )
    except Exception as e:
        raise HTTPException(status_code=400, detail={"data": None, "error": str(e), "success": False})
...
async def get_quiz(
    ...
    try:
        data = await service.get_quiz_by_id(quiz_id)
        return Utils.create_response(data["data"],data["success"],data.get("error", "") )
    except Exception as e:
...
async def update_quiz(
    ...
    try:
        data = await service.update_quiz(quiz_id, body.model_dump(exclude_unset=True))
        return Utils.create_response(data["data"],data["success"],data.get("error", "") )
    except Exception as e:
        raise HTTPException(status_code=400, detail={"data": None, "error": str(e), "success": False})
...
async def add_question(
    ...
    try:
        data = await service.add_question(quiz_id, body)
        return Utils.create_response(data["data"], data["success"], data.get("error", ""))
    except Exception as e:
        raise HTTPException(
            status_code=400,
...
async def update_question(
    ...
    try:
        data = await service.update_question(quiz_id, question_id, body)
        return Utils.create_response(data["data"], data["success"], data.get("error", ""))
    except Exception as e:
        raise HTTPException(
            status_code=400,
...
async def remove_question(
    ...
    try:
        data = await service.remove_question(quiz_id, question_id)
        return Utils.create_response(data["data"], data["success"], data.get("error", ""))
    except Exception as e:
        raise HTTPException(
            status_code=400,
